...
$(function(){
	$(".numero").mask("#", {placeholder: "Somente números"});
	$(".cpf").mask("00000000000", {placeholder: "Somente números",clearIfNotMatch: true});
	$(".cep").mask("00000000", {placeholder: "Somente números",clearIfNotMatch: true});
	$(".data").mask("00/00/0000", {placeholder: "__/__/____",clearIfNotMatch: true});
	$(".dataehora").mask("00/00/0000 00:00", {placeholder: "__/__/____ __:__",clearIfNotMatch: true});
	$(".hora").mask("00:00", {placeholder: "__:__",clearIfNotMatch: true});
	$(".dinheiro").mask('#0,00', {placeholder: "0,00",reverse: true});
});
